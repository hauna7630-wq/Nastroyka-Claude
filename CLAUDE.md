...
>
> Последнее обновление: 2026-06-05 (добавлен PREMIUM_UI_ENGINE.md)
...
- **Frontend/UI:** при проектировании любого UI (`web/`, `admin/`) следовать
  протоколу [`PREMIUM_UI_ENGINE.md`](./PREMIUM_UI_ENGINE.md) — премиум-стандарт
  дизайна и качества (анти-шаблонный манифест, чек-лист, обязательные состояния
  компонентов, брифинг перед версткой, self-correction loop).
...
- **2026-06-05** — добавлен `PREMIUM_UI_ENGINE.md` (премиум-протокол UI/дизайна
  и автономного цикла); ссылка на него — в разделе «Соглашения по коду».
