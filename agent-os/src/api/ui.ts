...
<body>
<aside id="side">
  <div class="logo">🤖 <span class="ltext">agent-os</span> <span class="vbadge" style="color:#2ea043;font-size:11px;font-weight:600">v70 · сотрудники сами создают файлы/PDF/скрипты (без «нажми Allow»)</span></div>
