...
<body>
<aside id="side">
  <div class="logo">🤖 <span class="ltext">agent-os</span> <span class="vbadge" style="color:#2ea043;font-size:11px;font-weight:600">v69 · тяжёлые задачи доходят до конца (лимит ходов 40)</span></div>
